"""
Django settings for django_view_perm project.
...
APP_DIR = join(ROOT_DIR, 'django_view_perm')
...
ROOT_URLCONF = 'django_view_perm.urls'

WSGI_APPLICATION = 'django_view_perm.wsgi.application'
